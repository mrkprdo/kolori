 ...
 */
export function getDeviceAddress(device: WledDevice | undefined): string | null {
 ...
 */
export function getWebSocketProtocol(device: WledDevice | undefined): 'ws' | 'wss' {
...
export function filterSeasonalPresets<T extends { name: string }>(items: T[]): T[] {
